...
void VClientWindow::paintEvent(QPaintEvent *)
{
    ...
    painter.drawText(_diagram_window->x() + 5, _diagram_window->y() + _diagram_window->height() + 20, "Receive");
    painter.drawText(_diagram_window->x() + 155, _diagram_window->y() + _diagram_window->height() + 20, "Send");
    ...
    painter.drawText(_diagram_window->x() + 5, _diagram_window->y() + _diagram_window->height() + 50, QString::number(_last_receive - 1) + " Kbps");
    painter.drawText(_diagram_window->x() + 155, _diagram_window->y() + _diagram_window->height() + 50, QString::number(_last_send - 1) + " Kbps");

    painter.drawText(_diagram_window->x() + 300, _diagram_window->y() + _diagram_window->height() + 50, _host_name);
}

void VClientWindow::screenButtonClickSlot()
{
    _screen_window->setWindowTitle(_host_name);
    _screen_window->show();
}
